...
_DEVICETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPILE_TIME_MAX_DEVICE_TYPES', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ONLY_FOR_TEST', index=7, number=20901701,
      options=None,
      type=None),
  ],
